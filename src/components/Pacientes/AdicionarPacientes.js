...
const AdicionarPacientes=()=>{
  ...
  return(
        ...
        <Link to='/pacientes'> <Button style={{backgroundColor:'#641864',borderColor:'black'}} className="w-10 btn btn-sm btn-primary">Voltar</Button> </Link>
        </div>
       ...
       <Formik
        ...
        onSubmit={values=>{
            instance.post(`/pacientes`,{nome:values.nome,telefone:values.telefone,email:values.email,cpf:values.cpf,endereco:{
                UF:values.UF,
